...
<h2 id="about-me" class="home-section-title">👋 About Me</h2>

Welcome to my homepage. My work sits at the intersection of `Computational Pathology` and `AI for Bioinformatics`. My published research spans whole-slide image analysis, biomarker prediction, and drug-target interaction modeling. My current unpublished work mainly focuses on whole-slide pathology image analysis, involving Mamba-based modeling, agent-style reasoning, and related theoretical derivation. Outside research, I enjoy fitness with my good buddies [Chao](https://weipengchao.top/) and [Le](https://dutianle.ltd/), and Teamfight Tactics（金铲铲）.

<h2 id="research-journey" class="home-section-title">🧭 Research Journey</h2>
...
<div class="experience-timeline">
  <div class="experience-item experience-item--right">
    ...
    <div class="experience-item__content">
      ...
      <p class="experience-item__desc">
        Studying Computer Science and Technology, with current work centered on computational pathology, whole-slide image analysis, and AI for bioinformatics. Advisor: Prof. Ran Su (<a href="https://scholar.google.com/citations?hl=en&user=gHzXz_YAAAAJ&view_op=list_works&sortby=pubdate" target="_blank" rel="noreferrer">Google Scholar</a>).
      </p>
    </div>
  </div>
  ...
  <div class="experience-item experience-item--left">
    <div class="experience-item__content">
      ...
      <p class="experience-item__desc">
        Completed my undergraduate study in Computer Science and Technology, building the foundation for later work on MSI status prediction, PCDH8 status prediction, and multimodal biomedical learning. Mentor: Prof. Liangliang Liu (<a href="https://scholar.google.com/citations?user=oHjrUo0AAAAJ&hl=en" target="_blank" rel="noreferrer">Google Scholar</a>).
      </p>
    </div>
    <div class="experience-item__axis"><span class="experience-item__dot"></span></div>
    <div class="experience-item__spacer"></div>
...
<h2 id="selected-publications" class="home-section-title">📚 Selected Publications</h2>
...
<h2 id="selected-honors" class="home-section-title">🏆 Selected Honors</h2>

<section class="honors-section" aria-label="Selected Honors">
  <ul class="honors-list">
    <li class="honors-item">
      <span class="honors-item__year">2024</span>
      <div class="honors-item__content">
        <div class="honors-item__title">National Encouragement Scholarship</div>
      </div>
    </li>
    <li class="honors-item">
      <span class="honors-item__year">2024</span>
      <div class="honors-item__content">
        <div class="honors-item__title">Second Prize, 25th National Robot and Artificial Intelligence Competition</div>
      </div>
    </li>
    <li class="honors-item">
      <span class="honors-item__year">2023</span>
      <div class="honors-item__content">
        <div class="honors-item__title">National Encouragement Scholarship</div>
      </div>
    </li>
    <li class="honors-item">
      <span class="honors-item__year">2023</span>
      <div class="honors-item__content">
        <div class="honors-item__title">Second Prize, 15th National College Student Electrical Mathematical Modeling Competition</div>
      </div>
    </li>
    <li class="honors-item">
      <span class="honors-item__year">2023</span>
      <div class="honors-item__content">
        <div class="honors-item__title">Third Prize, National College Student Robotics Innovation Exchange Camp and Competition</div>
      </div>
    </li>
    <li class="honors-item">
      <span class="honors-item__year">2023</span>
      <div class="honors-item__content">
        <div class="honors-item__title">First Prize, Provincial Division, 15th National College Student Mathematics Competition</div>
      </div>
    </li>
    <li class="honors-item">
      <span class="honors-item__year">2022</span>
      <div class="honors-item__content">
        <div class="honors-item__title">National Encouragement Scholarship</div>
      </div>
    </li>
...
<h2 id="links" class="home-section-title">🔗 Links</h2>
